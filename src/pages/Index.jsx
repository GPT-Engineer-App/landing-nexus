...
import { FaArrowRight, FaCloud, FaRocket, FaServer } from "react-icons/fa";
  ...
  return (
    <Box minH="100vh" bg="gray.50">
      ...
      <Flex bg="white" p={10} align="center" justify="space-around">
        <Feature icon={<FaServer />} title="Secure Cloud Storage" description="Keep your data safe and accessible with our top-tier, secure cloud storage solutions." />
